...
<section class="cta-bottom" style="text-align: center; padding: 100px 20px; position:relative; overflow: hidden;">
    ...
    <!-- Blask tła CTA -->
    <div
        style="position:absolute; top:50%; left:50%; width: 400px; height: 400px; transform:translate(-50%, -50%); background: radial-gradient(circle, rgba(138,43,226,0.15) 0%, transparent 70%); z-index: 1; pointer-events: none;">
    </div>
</section>

<!-- MAIN FOOTER -->
<footer class="main-footer"
    style="border-top: 1px solid var(--border-color); background: rgba(10,10,18,0.8); padding: 60px 20px 30px;">
    <div class="footer-content"
        style="max-width: 1200px; margin: 0 auto; display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 40px;">
        ...
        <div class="footer-col" style="display:flex; flex-direction:column; gap:20px;">
            ...
            <p style="color: rgba(255,255,255,0.7); line-height: 1.6; font-size: 0.95rem;">
                ...
                obiektów. Tworzymy światy od zera, łącząc technikę, scenografię i aktorstwo.
            </p>
        </div>
    ...
    <div
        style="max-width: 1200px; margin: 40px auto 0; padding-top: 30px; border-top: 1px solid rgba(255,255,255,0.1); text-align: center; color: rgba(255,255,255,0.5); font-size: 0.85rem;">
        <p>&copy; <?php echo date('Y'); ?> LegacyEvents. Wszelkie prawa zastrzeżone.</p>
    </div>
</footer>
